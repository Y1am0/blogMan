...
export function EditorSidebar({ publishDate, setPublishDate, tags, setTags, keywords, setKeywords, handlePreview, handleImageUpload }: EditorSidebarProps) {
 return (
   <div className="lg:w-1/3 space-y-4 flex flex-col">
     <div className="space-y-4 flex-grow">
       ...
       <FeaturedImageUpload onImageUpload={handleImageUpload} />
